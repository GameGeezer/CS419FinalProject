...
public class Entity {
    ...
    public final void addComponent(final EntityComponent component) throws EntityException {
        ...
        if (componentMap.get(component.getClass()) == null) {
            ...
            componentMap.put(component.getClass(), new ArrayList<EntityComponent>());
        }
        ...
        for(Map.Entry<Class, List<EntityComponent>> mapEntry : componentMap.entrySet()) {

            for(EntityComponent componentEntry : mapEntry.getValue()) {
