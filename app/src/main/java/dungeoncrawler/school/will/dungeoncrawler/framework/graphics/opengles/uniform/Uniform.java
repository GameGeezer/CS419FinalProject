...
public abstract class Uniform {
     ...
     */
    public Uniform(final String uniformName) {
     ...
     */
    public void addListener(final ShaderProgram listener) {
     ...
     */
    public void removeListener(final ShaderProgram listener) {
    ...
    protected void updateListeningShaders() {
        ...
        for(ShaderProgram listener : listeners) {
     ...
     */
    protected abstract void updateProgram(final int uniformHandle);

    /**
     * Update the shader uniform
     * @param shader the program to be updated
     */
    private void passUniformToShader(final ShaderProgram shader) {

        shader.bind();

        // Find the handle to the uniform
        final int uniformHandle = shader.getUniformLocation(uniformName);
