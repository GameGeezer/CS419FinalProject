package dungeoncrawler.school.will.dungeoncrawler.util.math;
...
public class Matrix4 implements Cloneable {
    ...
    public Matrix4 set(float[][] data) {
        ...
        this.data[M30] = data[3][0];
        this.data[M01] = data[0][1];
        this.data[M11] = data[1][1];
        this.data[M21] = data[2][1];
        this.data[M31] = data[3][1];
        this.data[M02] = data[0][2];
        this.data[M12] = data[1][2];
        this.data[M22] = data[2][2];
        this.data[M32] = data[3][2];
        this.data[M03] = data[0][3];
        this.data[M13] = data[1][3];
        this.data[M23] = data[2][3];
        this.data[M33] = data[3][3];
    ...
    public Matrix4 set(float[] data) {
        ...
        this.data[M30] = data[M30];
        this.data[M01] = data[M01];
        this.data[M11] = data[M11];
        this.data[M21] = data[M21];
        this.data[M31] = data[M31];
        this.data[M02] = data[M02];
        this.data[M12] = data[M12];
        this.data[M22] = data[M22];
        this.data[M32] = data[M32];
        this.data[M03] = data[M03];
        this.data[M13] = data[M13];
        this.data[M23] = data[M23];
        this.data[M33] = data[M33];
